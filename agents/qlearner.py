...
class Model(nn.Layer):
    def __init__(self, inputsize: int, outputsize: int) -> None:
        self.lay0 = nn.LayerLinear(inputsize, 64)
...
class qlearner(object):
    def __init__(self, state_size: int, action_size: int) -> None:
        ...
        self.replay_buffer: Deque[Tuple[np.array, np.array, np.array]] = collections.deque() # holds remembered (state, action, horizon) tuples
